console.log("JavaScript para ng_blocos carregado.");

function iniciarSorteioBlocos(formId, animationId) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (formSortearBlocos) {
        formSortearBlocos.addEventListener('submit', function(event) {
            ...
            iniciarSorteioBlocos('sortearBlocosForm', 'loadingAnimation');
        });
    }
    ...
    if (formSortearBlocosNovamente) {
        formSortearBlocosNovamente.addEventListener('submit', function(event) {
            event.preventDefault(); // Previne o comportamento padrão do botão
            iniciarSorteioBlocos('sortearBlocosNovamenteForm', 'loadingAnimation');
        });
    }
});
