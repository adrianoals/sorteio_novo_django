...
urlpatterns = [
        ...
        path('3coelhos-menu/', tres_coelhos_menu, name='tres_coelhos_menu'),
        # Rota para iniciar o sorteio
        path('3coelhos-sorteio/', tres_coelhos_sorteio, name='tres_coelhos_sorteio'), 
        ...
        path('3coelhos-qrcode/', tres_coelhos_qrcode, name='tres_coelhos_qrcode'),
        
        # Rota para iniciar o sorteio dupla
        path('3coelhos-dupla/', tres_coelhos_dupla, name='tres_coelhos_dupla'), 
        # Rota para exportar os resultados do sorteio para um arquivo Excel
        path('sorteio/dupla/excel/', tres_coelhos_dupla_excel, name='tres_coelhos_dupla_excel'),
        
        # Rota para zerar o sorteio
        path('3coelhos-zerar/', tres_coelhos_zerar, name='tres_coelhos_zerar'),

        # Rota para o resultado
        path('3coelhos-resultado/', tres_coelhos_resultado, name='tres_coelhos_resultado'),
        ...
        path('3coelhos-configurar-pne/', tres_coelhos_configurar_pne, name='tres_coelhos_configurar_pne'),
        path('3coelhos-configurar-duplas/', tres_coelhos_configurar_duplas, name='tres_coelhos_configurar_duplas'),
