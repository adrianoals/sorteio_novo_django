...
class ApartamentoAdmin(admin.ModelAdmin):
    list_display = ('id', 'numero', 'bloco', 'pne', 'vaga_coberta')
    search_fields = ('numero', 'bloco')
    list_filter = ('bloco', 'pne', 'vaga_coberta')
    list_editable = ('pne', 'vaga_coberta')
    ...
    def export_to_csv(self, request, queryset):
        ...
        writer.writerow(['ID', 'Número', 'Bloco', 'PNE', 'Vaga Coberta'])
...
class VagaAdmin(admin.ModelAdmin):
    list_display = ('id', 'numero', 'andar', 'tamanho', 'pne', 'vaga_coberta')
    search_fields = ('numero',)
    list_filter = ('andar', 'tamanho', 'pne', 'vaga_coberta')
    ...
    def export_to_csv(self, request, queryset):
        ...
        writer = csv.writer(response)
        writer.writerow(['ID', 'Número', 'Andar', 'Tamanho', 'PNE', 'Vaga Coberta'])
...
class SorteioAdmin(admin.ModelAdmin):
    ...
    list_filter = ('apartamento__bloco', 'vaga__andar')
